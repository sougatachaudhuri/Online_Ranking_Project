...
T=20;var=245; % T=20 is is the number of times the code runs over the entire Yandex dataset. Var is the feature dimension of Yandex matrices
...
for runs=1:totalruns
    count=0;
    for t= 1:T
        f = fopen('/Users/sougatachaudhuri/Documents/Experiments/Yandex/imat2009_learning.txt');
        ...
        while 1
            ...
            [~,  ~, ~, ind] = sscanf(l1,'%d:%f'); l1(1:ind-1)=[];
            [nqid, ~, ~, ind] = sscanf(l1,'# %d');Q(i,1)=nqid; tempqid= Q(i,1);
            nqid=num2str(nqid); 
            % Finished reading
            if ~strcmp(nqid,qid)
                if(q~=0)
...
fileid=fopen('/Users/sougatachaudhuri/Documents/Experiments/ResultsTopKYandex/Param1_SquaredNDCG10.txt','wt');
fprintf(fileid,'%f\t\n',AvgNDCGSquaredGain);
fclose(fileid);
fileid=fopen('/Users/sougatachaudhuri/Documents/Experiments/ResultsTopKYandex/Param1_SvmNDCG10.txt','wt');
fprintf(fileid,'%f\t\n',AvgNDCGSvmGain);
fclose(fileid);
fileid=fopen('/Users/sougatachaudhuri/Documents/Experiments/ResultsTopKYandex/Param1_KLNDCG10.txt','wt');
fprintf(fileid,'%f\t\n',AvgNDCGKLGain);
fclose(fileid);
fileid=fopen('/Users/sougatachaudhuri/Documents/Experiments/ResultsTopKFYandex/Param1_SmoothNDCG10.txt','wt');
fprintf(fileid,'%f\t\n',AvgNDCGSmoothGain);
fclose(fileid);
fileid=fopen('/Users/sougatachaudhuri/Documents/Experiments/ResultsTopKYandex/Param1_ListNetNDCG10.txt','wt');
fprintf(fileid,'%f\t\n',AvgNDCGListNetGain);
fclose(fileid);
fileid=fopen('/Users/sougatachaudhuri/Documents/Experiments/ResultsTopKFYandex/Param1_RandomNDCG10.txt','wt');
fprintf(fileid,'%f\t\n',AvgNDCGRandomGain);
fclose(fileid);
