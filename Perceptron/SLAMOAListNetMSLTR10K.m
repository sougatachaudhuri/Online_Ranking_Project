...
count=0;
% Here, loops iterates over all 5 Folds, while t iterates over each fold.
for loops=1:1
    for t= 1:T
        str=folds(t,:);
        filestring=strcat('E:\Papers\Programs\MSLTR10K\',str,'\train.txt');
        f = fopen(filestring);
...
fileid=fopen('E:\Papers\Programs\MSLTR10K\Experiments\ListNetNDCG10.txt','wt');
fprintf(fileid,'%f\t\n',AvgNDCGListNetGain);
fclose(fileid);
fileid=fopen('E:\Papers\Programs\MSLTR10K\Experiments\OANDCG10.txt','wt');
fprintf(fileid,'%f\t\n',AvgNDCGOAGain);
fclose(fileid);
...
fprintf(fileid,'%f\n',wrankListNet);
fclose(fileid);
fileid=fopen('E:\Papers\Programs\MSLTR10K\Experiments\OARanker.txt','wt');
fprintf(fileid,'%f\n',wrankOA);
fclose(fileid);
fileid=fopen('E:\Papers\Programs\MSLTR10K\Experiments\SLAMRanker.txt','wt');
fprintf(fileid,'%f\n',wrankSLAM);
fclose(fileid);
